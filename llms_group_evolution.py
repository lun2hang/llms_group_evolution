#modify a trl demo to orgnize a group of llms to generate more positive consequent comments to a movie, a bert based sentiments classifier acts as reward model, max reward caped by 3.0
...
positive_sample_scentiment_threshhold_maximum = 2.980
    ...
    for j in range(num_epoch):
        ...
        for k in range(num_llms):
            ...
            for _epoch, batch in tqdm(enumerate(ppo_trainer.dataloader)):
                ...
                batch_positive_review = [review for review, reward in zip(texts, rewards) if (reward > positive_sample_scentiment_threshhold or reward == max_reward)]
